...
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.2_Circuito_Ensamblado.png" width=650 height=350>
</p>
...
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.2_Codigo.png" width=500 height=400>
</p>

3. Inserte imágenes que considere como evidencias para demostrar el resultado obtenido.
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.2_Evidencia.png">
</p>

Conclusión: Mietras no se presionaba el botón solo se mostraban 0s estaba en estado apagado, y cuando se mantenia presionado el botón se mostraban 1s estaba en estado encendido.
...
:memo: [Actividad C3.2 ](https://github.com/NellyQuino/SistemasProgramables/blob/main/Blog/C3.2_ArduinoIDE_EntradaDigitalImpresionSerial.md)
