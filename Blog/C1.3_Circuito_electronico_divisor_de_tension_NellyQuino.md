...
<h2><strong>C1.3 Circuito electrónico divisor de tensión </strong></h2>
...
<p>¿Cual es la diferencia entre un sensor y un transductor?</p>
      Un sensor es un dispositivo electrónico capaz de detectar la variación de una magnitud física y el trasductor es un dispositivo que trasforma un tipo de variable fisica en otra cosa que facilita su medida. 
</li>
<li>
<p>Cuales son los elementos importantes de un sensor?</p>
      Elemento sensor y cicuto electrónico de acondicionamiento de la señal.
</li>
<li>
...
<p align="left">
     <img alt="Circuito" src="../img/C1.x_SensoresTransductoresCircuitoVout.png" 
...
<p align="left">
     <img alt="Circuito" src="../img/Simulacion-1.3a4.png" 
...
<td>?</td>
                ...
                1.5v, R2 = ?
                R2 = (1.5v * 750 ohm)/(5v - 1.5v)
                R2 = 321.43 ohm

                2.2v, R2 = ?
                R2 = (2.2v * 750 ohm)/(5v - 2.2v)
                R2 = 589.29 ohm
...
<img alt="Circuito" src="../img/Simulacion-1.3a52.png" 
     width=600 height=300>
     <img alt="Circuito" src="../img/Simulacion-1.3a53png.png" 
     width=600 height=300>
<img alt="Circuito" src="../img/Simulacion-1.3a5.png" 
     width=600 height=300>
<img alt="Circuito" src="../img/Simulacion-1.3a51.png" 
     width=600 height=300>
