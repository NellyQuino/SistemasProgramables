...
<p align="center">
    <img alt="Ensamble" src="../img/C3.1_Ensamble.png" width=600 height=400>
</p>
...
<p align="center">
    <img alt="Código" src="../img/C3.1_Codigo.png">
</p>

3. Explique el resultado observado.

    *Al LED se le manda voltaje por el pin 13 con ello el LED se enciende  1 segundo se pone en estado alto luego se apaga 1 segundo se pone en estado bajo.*

4. Inserte aquí las imágenes que considere como evidencias para demostrar el resultado obtenido.

<p align="center">
    <img alt="Evidencia" src="../img/C3.1_Evidencia.png">
</p>
...
:memo: [Actividad C3.1 ](https://github.com/NellyQuino/SistemasProgramables/blob/main/Blog/C3.1_%20Arduino_IDE_Salida_Digital.md)
